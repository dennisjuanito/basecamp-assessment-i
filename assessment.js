...
var notHakeem = (myName != "Hakeem Olajuwon") ? true : (myName == "Karl Malone");
...
// variable value based off of a passed in value. The param value passed in will be added in the unit test. 
...
var responseCreator = function(param){
  ...
  } else { //not equal to red or green
...
//return a string that says something like this 'Hi! I am Bryan and I am 28 years old" but with
